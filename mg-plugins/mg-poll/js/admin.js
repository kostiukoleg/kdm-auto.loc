...
var mgPoll = (function() {
  ...
  return { 
    ...
    init: function() {
      ...
      $('.admin-center').on('click', '.section-'+mgPoll.pluginName+' #add-plug-modal .save-button', function() { 
        var id = $(this).attr('id');
        mgPoll.saveField(id);        
      });
     ...
     // Нажатие на кнопку - активности
      ...
      $('.admin-center').on('click', '.section-'+mgPoll.pluginName+' #add-plug-modal .set-visible-period', function(){
      ...
      $('.admin-center').on('click', '.section-'+mgPoll.pluginName+' #add-plug-modal #add-answer-button', function(){
        mgPoll.addNewAnswerLine();
      });
      
      $('.admin-center').on('click', '.section-'+mgPoll.pluginName+' #add-plug-modal .delete-answer', function(){
    ...
    */         
    clearField: function() {
      ...
      $('.section-'+mgPoll.pluginName+' #add-plug-modal input').val('');  
      $('.section-'+mgPoll.pluginName+' .poll-answers').empty();
      $('.section-'+mgPoll.pluginName+' #add-plug-modal .save-button').attr('id','');
    },
      ...
      if(replaceTr){
        ...
        var tr = '\
         <tr data-id="'+data.id+'">\
          ...
          <td class="date_from" style="text-align: center;">'+date_from+'</td>\
          <td class="votes-count" style="text-align: center;">'+votes_count+'</td>\
          <td class="actions">\
            <ul class="action-list">\
              <li class="edit-row" data-id="'+data.id+'"><a class="tool-tip-bottom fa fa-pencil" href="javascript:void(0);" title="'+lang.EDIT+'"></a></li>\
              <li class="visible tool-tip-bottom '+activity+'" data-id="'+data.id+'" title="'+mgPoll.lang.ACT_V_ENTITY+'"><a class="fa fa-lightbulb-o '+activity+'" href="javascript:void(0);"></a></li>\
        ...
        <tr data-id="'+data.id+'">\
          ...
          <td style="text-align: center;">'+votes_count+'</td>\
          <td class="actions">\
            <ul class="action-list">\
              <li class="edit-row" data-id="'+data.id+'"><a class="tool-tip-bottom fa fa-pencil" href="javascript:void(0);" title="'+lang.EDIT+'"></a></li>\
              <li class="visible tool-tip-bottom active" data-id="'+data.id+'" title="'+mgPoll.lang.ACT_V_ENTITY+'"><a class="fa fa-lightbulb-o active" href="javascript:void(0);"></a></li>\
              <li class="delete-row" data-id="'+data.id+'"><a class="tool-tip-bottom fa fa-trash" href="javascript:void(0);"  title="'+lang.DELETE+'"></a></li>\
            </ul>\
          </td>\
        </tr>';
    ...
    addNewAnswerLine: function(number){
      ...
      $('.section-'+mgPoll.pluginName+' #add-plug-modal .poll-answers').append(answer);
    },
