...
<!--   <div class="b-modal hidden-form">
  ...
  <div class="reveal-overlay" style="display:none;">
    <div class="reveal xssmall add-news-form" id="add-plug-modal" style="display:block;">
      <button class="close-button closeModal" type="button"><i class="fa fa-times-circle-o" aria-hidden="true"></i></button>
      <div class="reveal-header">
        <h4><i class="fa fa-plus-circle" aria-hidden="true"></i> <span id="modalTitle"><?php echo $lang['MODAL_TITLE'];?></span></h4>
      </div>
...
<!--              <label><a href="javascript:void(0);" class="set-visible-period note" data-change-text="<?php echo $lang['HIDE_PERIOD_PARAMS'];?>"><span><?php echo $lang['VISIBLE_PERIOD_PARAMS'];?></span></a></label>
            ...
            <div class="clear"></div>
            <button class="custom-btn add-answer-button tool-tip-bottom button secondary" id="add-answer-button" title="<?php echo $lang['T_TIP_PREVIEW'];?>"><span><i class="fa fa-plus-circle"></i> <?php echo $lang['ADD_ANSWER'];?></span></button>
          </div>

        </div></div>
        <div class="reveal-footer clearfix">
        <a class="button success fl-right save-button add-answer-button tool-tip-bottom" title="<?php echo $lang['T_TIP_SAVE'];?>" href="javascript:void(0);"><i class="fa fa-floppy-o" aria-hidden="true"></i> <?php echo $lang['SAVE'];?></a>
      </div>
    </div>
  </div>
  ...
  <div class="widget-table-body">
    <div class="widget-table-action">
      <a href="javascript:void(0);" class="custom-btn add-new-button button success"><span><i class="fa fa-plus-circle"></i> <?php echo $lang['ADD_MODAL'];?></span></a>
          ...
          <table class="widget-table main-table">
            <thead>
              <tr>
                ...
                <th style="width:300px;text-align: center;"><?php echo $lang['NAME'];?></th>
                <th style="width:100px;"><?php echo $lang['DATE_ACTIVE_FROM'];?></th>
                <th style="width:100px;text-align: center;"><?php echo $lang['VOTES_COUNT'];?></th>
                ...
                <tr class="no-results">
                  ...
                  <?php else:?>
                    ...
                    <tr data-id="<?php echo $row['id'];?>">
                      ...
                      <td class="votes-count" style="text-align: center;"><?php echo $row['votes_count'];?></td>
                      <td class="actions">
