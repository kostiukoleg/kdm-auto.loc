  ...
  <div class="widget-table-body">
    <div class="wrapper-entity-setting">
      ...
      <div class="widget-table-action base-settings">
        ...
        <button class="tool-tip-bottom base-setting-save save-button custom-btn button success" data-id="" title="<?php echo $lang['SAVE_MODAL']?>">
          <span><i class="fa fa-floppy-o"></i> <?php echo $lang['SAVE_MODAL']?></span> <!-- кнопка применения настроек -->
        </button>
        <div class="clear"></div>
      </div>
      <div class="clear"></div>
