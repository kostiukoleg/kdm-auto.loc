      ...
      <div class='content-modal-back-ring'>
        ...
        <ul class='modal-ring-list'>
            ...
            <li style='".(($options['period']!='true')?'display:none':'')."'>
                ...
                <span>Укажите время и дату, когда вам удобно сделать замер</span>
                ...
                <div class='right' style='".(($options['date']!='true')?'display:none':'')."'>
                     ...
                     <input type='text' name='date_callback' placeholder='Дата для замера'>
            ...
            <li style='".(($options['caphpa']!='true')?'display:none':'')."'>
                ...
                <div class='cap-left'>
                    ...
                    <img alt='Cap' style='margin-top: 5px; border: 1px solid gray; background: url(".PATH_TEMPLATE."/images/cap.png)' src=\"".SITE."/captcha.html\" width=\"140\" height=\"36\">
