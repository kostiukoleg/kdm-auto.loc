...
<div class="section-<?php echo $pluginName ?>"><!-- $pluginName - задает название секции для разграничения JS скрипта -->
      ...
      <div class="widget-table-body slide-editor"><!-- Содержимое окна, управляющие элементы -->
        ...
        <div class="block-for-form" >
          <ul class="custom-form-wrapper fields-calback">
            ...
            <li>
              <span>Ваш адрес</span> <input type="text" name="city_id" value=""/>              
            </li>
            <li>
        ...
        <h2>Поля в форме звонка:</h2>
          <form  class="base-setting" name="base-setting" method="POST">       
              <ul class="list-option">
                  ...
                  <li><label><span>Адрес:</span> <input type="checkbox" name="city" value="<?php echo $options["city"]?>" <?php echo ($options["city"]&&$options["city"]!='false')?'checked=cheked':''?>></label></li>
                  ...
                  <li><span>Доступный период для заказа замера:</span> С
                    <select name="from">
                       <?php
        ...
        <div class="entity-settings-table-wrapper">
          <table class="widget-table">          
            ...
            <tr>
              ...
              <th>
               <a href="javascript:void(0);" class="field-sorter <?php echo ($sorterData[0]=="city_id") ? 'sort-dir-'.$sorterData[3]:'sort-dir-asc' ?>" data-sort="<?php echo ($sorterData[0]=="city_id") ? $sorterData[1]*(-1) : 1 ?>" data-field="city_id">Адрес</a>
              </th>
              <th>
  ...
  <script>
     ...
     $(".section-back-ring  .b-modal .fields-calback input[name=phone]").mask("+38 (999) 999-99-99");
  </script>