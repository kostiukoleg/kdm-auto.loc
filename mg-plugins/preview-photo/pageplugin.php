...
<div class="section-<?php echo $pluginName ?>"><!-- $pluginName - задает название секции для разграничения JS скрипта -->
  ...
  <div class="widget-table-body">
     ...
     <div class="widget-table-action">    
        <a href="javascript:void(0);" class="show-property-order tool-tip-top button" title="<?php echo $lang['T_TIP_SHOW_PROPERTY'];?>"><span><i class="fa fa-cogs"></i> <?php echo $lang['SHOW_PROPERTY'];?></span></a>
        <a href="javascript:void(0);" class="start-processs custom-btn button"><span><i class="fa fa-check" aria-hidden="true"></i>
 Начать процесс генерации миниатюр</span></a>       
        <br>
        <a href="javascript:void(0);" class="processs-get-photo custom-btn button"><span>Собрать все 100%-ные изображения в папку /uploads/original</span></a>
      ...
      <div class="property-order-container widget-panel-content" style="display: none;">    
        <h2>Настройки процесса генерации изображений:</h2>       
              <ul class="list-option">
                  ...
                  <li><label><span>Качество сжатия:</span> <input type="text" name="quality" value="<?php echo ($options["quality"])?$options["quality"]:'75'?>"></label></li>
                  ...
                  <li><label><span>Создавать миниатюры без предварительного сбора в папку с оригиналами</span> 
                      <input type="checkbox" name="alterAlg" 
                             value="<?php echo $options["alterAlg"]?>" <?php echo ($options["alterAlg"]&&$options["alterAlg"]!='false')?'checked=cheked':''?>
                             />
                    </label></li>
              </ul>
              <div class="clear"></div>          
          <div class="clear"></div>
        <a href="javascript:void(0);" class="base-setting-save custom-btn button success"><span><i class="fa fa-floppy-o"></i> Сохранить</span></a>
        <div class="clear"></div>
      </div>   
