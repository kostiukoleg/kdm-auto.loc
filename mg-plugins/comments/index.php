  ...
  static function showComments() {
    ...
    if (!empty($comments['comments'])) {
      foreach ($comments['comments'] as $item) {
        $html .= "
         <div itemprop='review' itemscope itemtype='http://schema.org/Review' class='comment-post'>
          <span itemprop='author' class='post-author'>".$item['name']."</span>
          <span itemprop='datePublished' class='post-date'>".$item['date']."</span>
          <p itemprop='description'>".$item['comment']."</p>
        </div>";
      }
