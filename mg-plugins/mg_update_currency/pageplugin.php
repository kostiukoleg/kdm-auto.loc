...
-->
<div class="section-<?php echo $pluginName?> plugin-padding"><!-- $pluginName - задает название секции для разграничения JS скрипта -->
  ...
  <div class="widget-table-body">
    <div class="wrapper-entity-setting">
      ...
      <div class="widget-table-action base-settings">
        <h3 style="margin:15px;">Настройки плагина</h3>
        ...
        <ul class="list-option"><!-- список опций из таблицы setting-->
          ...
          <li><label>
            ...
            <input type="text" name="margin" value="<?php echo $options['margin'];?>" <?php echo ($options["use_margin"]=='false')?'disabled=disabled':''?> class="tool-tip-right" title="<?php echo $lang['T_TIP_MARGIN']?>">
          </label></li>
          <li><label>
        ...
        <button class="tool-tip-bottom base-setting-save save-button button success custom-btn" data-id="" title="<?php echo $lang['SAVE_MODAL']?>" style="margin:15px;">
            <i class="fa fa-floppy-o"><span><?php echo $lang['SAVE_MODAL']?></span></i> <!-- кнопка применения настроек -->
        </button>
        <button class="tool-tip-bottom reload-slider update-price custom-btn button primary" data-id="" title=""  style="margin:15px;">
