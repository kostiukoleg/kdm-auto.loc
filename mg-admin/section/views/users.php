                        ...
                        <div class="add-user-form-wrapper">
                            <div class="add-user-form">
                                ...
                                <div class="controlEditorPas">
                                    <span class="custom-text"><?php echo $lang['USER_PASS'];?>:</span> <a href="javascript:void(0);" class="editPass tool-tip-bottom" title="<?php echo $lang['T_TIP_USER_PAS_EDIT'];?>"><span><?php echo $lang['USER_PASS_EDIT'];?></span></a>
                                </div>
