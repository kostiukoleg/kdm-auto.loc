...
function mgImageProduct($data){
  ...
  return '<img data-transfer="true" data-product-id="'.$data["id"].'" itemprop="image" src="'.$src.'" alt="'.$imagesData["image_alt"].'" title="'.$imagesData["image_title"].'" data-large="'.$srcLarge.'">';
}
/**
