    ...
    <div class="admin-wrapper no-print">
        ...
        <div class="header">
            <div class="info-panel">
                <div class="admin-logo-block">
                    <a href="javascript:void(0);" class="logo"><img src="<?php echo SITE?>/mg-admin/design/images/logo.png" alt="" /></a>
                ...
                <div class="fl-right">
                    <ul class="settings-list">
                        <li class="language"><a href="javascript:void(0);" title="<?php echo($lang['T_TIP_LANG_PACK']);?>" class="tool-tip-left"><span class="language-ru select-language-<?php echo $data['languageLocale']; ?>"></span></a>
                            <div class="language-list-wrapper">
                                <ul class="language-list dropdown-language-menu">
                                    <li class="russian"><a href="javascript:void(0);" class="ru_RU"><span class="ru-icon"></span>Русский</a></li>
                                    <li><a href="javascript:void(0);" class="en_EN"><span class="usa-icon"></span>English</a></li>
                                    <li class="ua"><a href="javascript:void(0);" class="ua_UA"><span class="ua-icon"></span>Украинский</a></li>
                                </ul>
                            </div>
                        </li>
                        ...
                        <li class="exit"><a href="javascript:void(0);" title="<?php echo($lang['QUIT']);?>" class="tool-tip-bottom logout-button"><span class="exit-icon"></span></a></li>
                    </ul>
                </div>
                <!--Правая часть верхней панели-->
            </div>
        ...
        <div class="admin-footer-block no-print">
            <div class="admin-copyright">
               <p>&copy; Все права защищены kdm-auto.com.ua™</p>
            </div>
        </div>
