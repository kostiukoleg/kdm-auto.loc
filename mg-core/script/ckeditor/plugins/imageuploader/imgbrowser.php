...
<div id="editbar">
    ...
    <a href="javascript:void(0);" id="editbarDownload" download><div class="editbarDiv"><img src="img/cd-icon-download.png" class="editbarIcon editbarIconLeft"><p class="editbarText"><?php echo $buttons2; ?></p></div></a>
...
<div id="imageFullSreen" class="lightbox popout">
    <div class="buttonBar">
        ...
        <a href="javascript:void(0);" id="imgActionDownload" download><button class="headerBtn"><img src="img/cd-icon-download.png" class="headerIcon"></button></a>
