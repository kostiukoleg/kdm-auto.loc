    ...
    activatePlugin: function(pluginName) {
      ...
      (function(response) {
        ...
        if(response.data.havePage){
          $('.go-to-plugins-settings').before('<li><a href="javascript:void(0);" class="'+pluginName+'">'+pluginTitle+'</li>');
          $('tr[id='+pluginName+']').removeClass('plugin-settings-off');
          $('tr[id='+pluginName+']').addClass('plugin-settings-on');
          $('tr[id='+pluginName+'] .action-list .delete-order').before('<li class="plugin-settings-large"><a class="plugSettings" href="javascript:void(0);" title="Настроить"></a></li>');
