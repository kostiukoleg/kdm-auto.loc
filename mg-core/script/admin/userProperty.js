        ...
        for (var i = 0; i <= strArr.length - 1; i++) {
          if (strArr[i]) {
            ...
            html += '<div class="' + clas + '" ' + hide + '><div class="prop"><span class="propertyDataName" style="cursor:move">' + admin.htmlspecialchars(admin.htmlspecialchars_decode(propertyData.name)) + '</span>\
                      ...
                      <span class="setMargin" style="display:none" > + <input type="text" name="valuenew" value="' + propertyData.margin + '"/> ' + admin.CURRENCY + ' </span>\
                    ...
                    <a href="javascript:void(0);" class="saveChangeItem tool-tip-top" title="' + lang.SAVE + '" data-propid="' + propId + '" data-number="' + i + '" style="display:' + display + '"></a>\
                     ...
                     <!-- <a href="javascript:void(0);" onclick="return false" class="setDefaultVal tool-tip-bottom" style="display:none" title="' + lang.SETUP_DEFAULT + '" data-value="' + admin.htmlspecialchars(admin.htmlspecialchars_decode(propertyData.name)) + '">' + lang.SETUP_DEFAULT + '</a>-->\
                    </div>';
          }
        }
      }
