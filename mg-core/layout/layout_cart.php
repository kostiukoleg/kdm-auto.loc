          ...
          <?php foreach($data['cartData']['dataCart'] as $item): ?>
            <tr>
              ...
              <td class="small-cart-remove">
                <a href="javascript:void(0);" class="deleteItemFromCart" title="Удалить" data-delete-item-id="<?php echo $item['id'] ?>"  data-property="<?php echo $item['property'] ?>"  data-variant="<?php echo $item['variantId'] ?>">&#215;</a>
              </td>
            </tr>
          <?php endforeach; ?>
